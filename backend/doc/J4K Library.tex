...
\maketitle
\chapter*{Pr\'eambule}
L'utilisation de la librairie J4K est soumise \`a conditions. Elle ne doit \^etre utilis\'ee uniquement pour des recherches. De plus, il est necessaire de faire apparaitre le texte suivant : 

\verb"If you use this Java library in your research, please cite the following article, which"

\verb"introduced this library: A. Barmpoutis. 'Tensor Body: Real-time Reconstruction of the" 

\verb"Human Body and Avatar Synthesis from RGB-D', IEEE Transactions on Cybernetics, Special" 

\verb"issue on Computer Vision for RGB-D Sensors: Kinect and Its Applications, October 2013,"

\verb"Vol. 43(5), Pages: 1347-1356."
...
Avec Kinect Studio, on peut enregistrer puis émuler une séquence Kinect.
\newline
...
\item Une fen\^etre s'ouvre, demandant de lancer la Kinect. Brancher la Kinect en USB et lancer le programme Java (qui doit contenir la ligne de commande \verb"start(int flag);", en rempla\c{c}ant l'entier flag par les fonctionnalités à activer).
